...
Attendre la CI automatique, corriger si nécessaire, valider la documentation, ouvrir la PR Lot 10 vers `main`, effectuer le squash merge, puis supprimer la branche obsolète.
